                ...
                <div className="skullcandy-intro-description skullcandy-left">
                    ...
                    <p className="skullcandy-lh">
                        <span className="skullcandy-text">
                            О том, как выбрать своё призвание, мы говорили с амбассадорами производителя наушников <a target="_blank" rel="noreferrer" href="https://www.skullcandy.com/">SkullCandy</a> — скейтбордистом Димой Давыдовым, хореографом Стасом Литвиновым и диджеем Мэри Джейн. Они рассказали нам, как превратили хобби в профессию и преодолевали трудности, вдохновляясь музыкой. Делимся личными историями героев и плейлистами с их любимыми треками.
                        </span>
                    </p>
                </div>
            </div >
